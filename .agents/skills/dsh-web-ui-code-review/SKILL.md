---
name: dsh-web-ui-code-review
description: Use when reviewing uncommitted changes, a branch, or a pull request for dsh-web-ui. Focuses on correctness, plugin boundaries, browser behavior, security, generated artifacts, and missing evidence.
whenToUse: A user asks to review dsh-web-ui code, a branch, a pull request, or a diff.
user-invocable: true
---

# Reviewing dsh-web-ui Changes
