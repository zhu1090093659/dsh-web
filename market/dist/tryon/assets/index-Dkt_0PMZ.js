import{b as u,ca as w,aS as b,cb as m,b8 as v,bi as g,bV as S,aV as E}from"./index-CljaGHc9.js";import{F as R}from"./index-BXSd_KB0.js";import"./git-DJDr4heb.js";const N="web-app",y=E(new URL("../../../..",import.meta.url)),U="webRuntime",j=["webServer"],A=u.object({openBrowser:u.boolean().default(!0),printUrl:u.boolean().default(!0),surfaceContext:u.boolean().default(!0),trustedHosts:u.array(String).default([])}),h="DSH_WEB_URL",O="127.0.0.1",_="0.0.0.0";function L(e){const r=v(e);return["SSH_CONNECTION","SSH_TTY"].some(n=>{const t=r.getFrom(n,["process"])?.value;return t!==void 0&&t!==""})}const T=import.meta.resolve("open"),C=`
try {
