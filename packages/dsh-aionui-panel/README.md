...
- `tests/` — pure-logic tests for the clamp formula, porcelain parsing, persistence validation, markdown/csv rendering, store behavior, and UI smoke tests (vitest, 24 test files).
...
File-type logos are vendored from the [vscode-icons](https://github.com/vscode-icons/vscode-icons) extension (MIT License), Copyright (c) 2016 Roberto Huertas and contributors.
