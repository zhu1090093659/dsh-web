 ...
 * behavior and offers the create-icon action.
 */

/** Simplified Chinese dictionary (the key-set source of truth). */
export const zh = {
  'settings.title': '桌面启动器',
  'settings.description': '在桌面创建一键启动图标，双击启动 dsh web 并打开 Web GUI。',
  'settings.enabled': '启用插件',
  'settings.enabledHint': '关闭后不再提供桌面图标创建与公告。',
...
export const en = {
  ...
  'settings.description': 'Create a one-click desktop icon that starts dsh web and opens the Web GUI.',
  'settings.enabled': 'Enable plugin',
  'settings.enabledHint': 'When off, desktop icon creation and the announcement stop.',
