...
export const ru: Record<string, string> = {
  ...
  'usage.foot.collapse': 'Свернуть карточку использования',
  'usage.foot.cost': 'Расход сегодня',
  'usage.foot.expand': 'Развернуть карточку использования',
  'usage.foot.noData': 'Сегодня использования пока не было',
  'usage.foot.open': 'Открыть настройки статистики использования',
