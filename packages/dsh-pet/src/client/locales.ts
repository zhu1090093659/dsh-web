...
export const zh = {
  ...
  'settings.skin': '宠物皮肤',
  'settings.skinHint': '在当前皮肤与原版皮肤之间切换。',
  'settings.skinRefined': '精致版',
  'settings.skinOriginal': '原版',
...
export const en = {
  ...
  'settings.skin': 'Pet skin',
  'settings.skinHint': 'Switch between the refined and original skin.',
  'settings.skinRefined': 'Refined',
  'settings.skinOriginal': 'Original',
