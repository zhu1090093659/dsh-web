...
export const zh = {
  ...
  'conversation.edit': '编辑',
  'conversation.edit.input': '编辑消息内容',
  'conversation.edit.save': '发送',
  'conversation.edit.cancel': '取消',
  'conversation.edit.saving': '处理中…',
  'conversation.edit.error': '编辑失败，原会话未改变。',
  'conversation.copy': '复制',
  'conversation.copied': '已复制',
  'conversation.image': '图片',
  'conversation.extraBlock': '消息附加内容',
  'conversation.jsonTruncated': '内容过长，已截断（共 {total} 个字符）',
  ...
  'settings.faultHandling': '故障处理',
  'settings.faultHandlingDescription': '模型请求失败时的自动恢复策略。',
  'settings.retryAttempts': '自动重试次数',
  'settings.retryAttemptsHint': '模型请求遇到可恢复故障时，首次请求之外最多重试指定次数；填写 0 表示关闭自动重试。工具执行不会自动重放。',
  'settings.inherit': '继承',
  'settings.on': '开',
  'settings.off': '关',
...
export const en = {
  ...
  'conversation.edit.input': 'Edit message content',
  'conversation.edit.save': 'Send',
  'conversation.edit.cancel': 'Cancel',
  'conversation.edit.saving': 'Working…',
  'conversation.edit.error': 'Edit failed; the original session was unchanged.',
  'conversation.copy': 'Copy',
  'conversation.copied': 'Copied',
  'conversation.image': 'Image',
  'conversation.extraBlock': 'Additional message content',
  'conversation.jsonTruncated': 'Content truncated ({total} characters)',
  ...
  'settings.faultHandling': 'Fault handling',
  'settings.faultHandlingDescription': 'Automatic recovery for failed model requests.',
  'settings.retryAttempts': 'Automatic retry attempts',
  'settings.retryAttemptsHint': 'For recoverable model-request failures, retry up to the configured number of times after the initial request; 0 disables automatic retry. Tool execution is never replayed automatically.',
