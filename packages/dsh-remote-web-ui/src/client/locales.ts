...
export const zh = {
  ...
  'settings.description': '配对安全、设备限额与故障处理。',
  ...
  'settings.retryAttempts': '故障处理：自动重试次数',
...
export const en = {
  ...
  'settings.description': 'Pairing security, device limits, and fault handling.',
  ...
  'settings.retryAttempts': 'Fault handling: automatic retry attempts',
