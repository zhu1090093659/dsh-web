/**
 * The /api/dsh-shutdown route contract: method gate, loopback fence, and the
 * deferred exit request (response first, exit a beat later).
 */

import { describe, expect, it } from 'vitest'
import type { IncomingMessage, ServerResponse } from 'node:http'
import { EXIT_DELAY_MS, makeShutdownRoute } from '../src/routes.ts'
