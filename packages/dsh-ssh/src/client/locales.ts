...
export const zh = {
  ...
  'form.password': '密码',
  'form.passwordHint': '明文保存在 $DSH_HOME/dsh-ssh.json（默认 ~/.dsh/dsh-ssh.json，本机私有文件）',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  'form.passwordHint': 'Stored in plaintext in $DSH_HOME/dsh-ssh.json (default ~/.dsh/dsh-ssh.json; private local file)',
