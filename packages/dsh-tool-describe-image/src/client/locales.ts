...
export const zh = {
  ...
  'field.baseURL': '接口地址',
  'field.baseURL.hint': 'OpenAI 兼容根地址；会自动追加 /chat/completions。',
  'field.model': '模型',
  ...
  'field.maxOutputTokens.hint': '发给端点的 max_tokens。',
...
export const en = {
  ...
  'field.baseURL.hint': 'OpenAI-compatible root URL; /chat/completions is appended automatically.',
  'field.model': 'Model',
  ...
  'field.maxOutputTokens.hint': 'The max_tokens sent to the endpoint.',
