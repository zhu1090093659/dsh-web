 ...
 * section, so there is no disclosure fold), followed by the built-in
 * version-notes card for the latest release.
 */

import type { ReactNode } from 'react'
import type { PropsLocale, PropsRenderSlots, PropsRuntime } from '@deepseek-ai/dsh-client-ui-slots'
import { ReleaseNotesCard } from './ReleaseNotesCard.tsx'
...
/** Render the family plugin cards plus the version-notes card under a static heading. */
