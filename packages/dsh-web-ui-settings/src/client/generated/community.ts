...
export const COMMUNITY_PLUGINS: readonly CommunityPluginEntry[] = [
  ...
  {"id":"dsh-skill-explorer","name":"Skill Explorer","nameEn":"Skill Explorer","author":"wingsky-1","repo":"https://github.com/zhu1090093659/dsh-web-ui","description":"DSH 技能中心：按来源分级浏览已加载 skill，支持启用/禁用、创建与删除（移入 .trash）。","descriptionEn":"DSH skill center: browse loaded skills grouped by source, with enable/disable, create and delete (move to .trash)."},
]
