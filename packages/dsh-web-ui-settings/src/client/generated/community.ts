...
export const COMMUNITY_PLUGINS: readonly CommunityPluginEntry[] = [
  ...
  {"id":"dsh-slamdunk-skin","name":"灌篮高手皮肤","nameEn":"Slam Dunk Skin","author":"jeffliu95800-source","repo":"https://github.com/jeffliu95800-source/dsh-slamdunk-skin","description":"《灌篮高手》主题界面 + 樱木花道桌面宠物：壁纸轮播、三栏透明磨砂、可拖拽/聊天/每小时换造型的矢量角色。","descriptionEn":"Slam Dunk themed UI + Sakuragi Hanamichi desktop pet: rotating wallpaper, frosted translucent columns, and a draggable/chatty vector character that swaps poses hourly."},
]
