...
export const COMMUNITY_PLUGINS: readonly CommunityPluginEntry[] = [
  ...
  {"id":"dsh-mnemon","name":"记忆系统","nameEn":"Memory System","author":"omdsh-dev","repo":"https://github.com/omdsh-dev/dsh-mnemon","description":"将 Mnemon 接入 DSH，提供可跨 Agent 共享的本地三层记忆系统：运行时记忆、可检索档案与长期记忆体。","descriptionEn":"Integrates Mnemon with DSH for cross-agent, local-first three-tier memory: Runtime Memory, searchable Documents, and long-term Memory Spaces.","npm":"dsh-mnemon"},
]
