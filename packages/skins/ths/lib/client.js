window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var ths_module_css_default = {
			"aionPreviewIn": "KcKNAG_aionPreviewIn",
			"thsStatusbar": "KcKNAG_thsStatusbar",
			"thsStatusbarCell": "KcKNAG_thsStatusbarCell",
			"thsStatusbarSpacer": "KcKNAG_thsStatusbarSpacer",
			"thsTitlebar": "KcKNAG_thsTitlebar",
			"thsTitlebarBtn": "KcKNAG_thsTitlebarBtn",
			"thsTitlebarIcon": "KcKNAG_thsTitlebarIcon",
			"thsTitlebarTicker": "KcKNAG_thsTitlebarTicker",
			"thsTitlebarTickerChg": "KcKNAG_thsTitlebarTickerChg",
			"thsTitlebarTickerVal": "KcKNAG_thsTitlebarTickerVal",
			"thsTitlebarTitle": "KcKNAG_thsTitlebarTitle"
		};
		//#endregion
